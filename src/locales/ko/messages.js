/*eslint-disable*/ module.exports = {
  messages: {
    ...
    "Development CONUN digital currency exchange alpha version platform":
      "거래소 ‘Alpha Version Platform’",
    "Development CONUN mobile application": "CONUN Mobile Application",
    "Development CONUN platform core & wallet": "CONUN Platform Core & Wallet",
    "Development and launch CONUN CHAIN CODES":
      "코넌 체인코드 CHAIN CODES Halla 런칭",
    ...
    "Development for CONUN mobile platform for android and iOS version":
      "Android 에서 CONUN Mobile Platform 설계 및 개발",
    ...
    "Launch CONUN Blockchain Explorer Testnet":
      "코넌 블록체인 익스플로러 테스트넷 CONUN Blockchain Explorer Testnet",
    "Launch CONUN Blockchain Middleware Testnet":
      "코넌 블록체인 미들웨어 테스트넷 CONUN Blockchain Middleware Testnet",
    "Launch CONUN Blockchain Testnet":
      "코넌 블록체인 테스트넷 CONUN Blockchain Testnet",
    "Launch CONUN Token Swap": "코넌 토큰 스왑(CONUN Token Swap) 런칭",
    "Launch Conun Wallet Web Extension":
      "CONUN 지갑 웹 익스텐션 (CONUN Wallet Web Extension) 런칭",
    ...
    "Launch distributed network (peer to peer) Alpha version in Github and pre-trial":
      "분산네트워크(peer to peer platform) 알파버전을 github 에 공개 및 배포합니다",
    ...
    "Make project for CONUN platform Test application in science circulation, deep learning, big data":
      "CONUN platform 에 동작할 수 있는 여러 종류의 분산 project 를 test 하고 검증을 합니다",
    ...
    "Make transportation & distributed data storage management in application":
      "File transportation & Distributed data storage management 응용프로그램의 데이터를 전송하고 관리하는 분산 데이터 저장 핵심을 설계하고 구현합니다.",
    "Make virtual machine system for personal PC app UI/UX":
      "개인용 컴퓨터의 어플리케이션 UI 와 UX 를 설계하고 응용프로그램이 작동하기 위한 가상머신 시스템을",
    Mar: "3월",
    May: "5월",
    ...
    "The first release of CONUN blockchain main services 'Halla - Release'. Complete CONUN DRIVE":
      "코넌의 최초 통합블록체인서비스 '한라 Halla' 대공개 여정 시작 코넌 드라이브 서비 CONUN DRIVE Halla 런칭",
    ...
    "Update CONUN p2p network traffic": "CONUN p2p network traffic 개선 작업",
    ...
    "korean-only-sub":
      "코넌의 한층 업그레이드된 블록체인서비스 '백두' 출시코넌 블록체인 메인넷, 코넌 블록체인 익스플로어를 런칭합니다",
    "korean-only-title":
      "코넌 블록체인 익스플로러 CONUN Blockchain Explorer Mainnet 런칭",
    "korean-sub-only algorithm key":
      "알고리즘 key 찾기 카테고리 버전을 시작으로 단계별로 여러 분야에 개발 및 관리를 시작합니다",
  },
};
