const items = [
  ...
  },
  {
    ...
    values: [
      ...
      {
        label: '메타콘 설치 휴대폰인증 3만명 도토리10개, 싸이콘650개',
        path: 'https://twitter.com/kimkongkong12/status/1683255436890497026?s=20',
        iconPath: '/images/sns/twitter.svg'
      },
      {
        label: '코넌코리아에서 메타콘 지갑 이벤트를 합니다.',
        path: 'https://twitter.com/Flowerjae94/status/1686698823178158080?s=20',
        iconPath: '/images/sns/twitter.svg'
      },
      {
        label: '싸이월드 도토리x싸이콘 코넌코리아 이벤트를 합니다.',
        path: 'https://twitter.com/Flowerjae94/status/1686703051011448832?s=20',
        iconPath: '/images/sns/twitter.svg'
      }
    ]
  },
